...
: "${SHOWY_BAR_CODEXBAR_SERVE_REFRESH_SECONDS:=10}"
: "${SHOWY_BAR_PROVIDERS:=}"
...
: "${SHOWY_BAR_SKETCHYBAR_UPDATE_FREQ:=10}"
...
: "${SHOWY_BAR_TERMINAL_BAR_MODE:=auto}"
: "${SHOWY_BAR_MONO3_PROVIDERS:=gemini,antigravity}"
